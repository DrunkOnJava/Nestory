...
public enum DateUtils {
    ...
    public nonisolated(unsafe) static let iso8601Formatter: ISO8601DateFormatter = {
    ...
    public nonisolated(unsafe) static let relativeDateFormatter: RelativeDateTimeFormatter = {
