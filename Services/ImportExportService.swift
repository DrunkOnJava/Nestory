...
public final class ImportExportService: ObservableObject {
    ...
    public enum ImportError: LocalizedError {
        ...
        public var errorDescription: String? {
            switch self {
            case .invalidFormat:
                return "Invalid file format. Please use CSV or JSON."
            case .missingRequiredFields:
                return "Missing required fields in import file."
            case .parsingError(let detail):
                return "Error parsing file: \(detail)"
            case .dataConversionError:
                return "Could not convert file data."
            }
        }
    }
