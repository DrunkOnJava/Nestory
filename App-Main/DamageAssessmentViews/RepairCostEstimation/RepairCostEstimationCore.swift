...
public struct CostEstimation {
    ...
    public var hourlyRate: Decimal = 50 // Default rate
    ...
    public struct RepairCost: Identifiable, Equatable {
        public let id = UUID()
    ...
    public struct AdditionalCost: Identifiable, Equatable {
        public let id = UUID()
        public let description: String
        public let amount: Decimal
        ...
        public enum CostType: String, CaseIterable, Codable {
            case temporaryHousing = "Temporary Housing"
