...
public final class BGTaskRegistrar {
    ...
    private let syncTaskIdentifier = "\(EnvironmentConfiguration.shared.bundleIdentifier).sync"
    private let cleanupTaskIdentifier = "\(EnvironmentConfiguration.shared.bundleIdentifier).cleanup"
    private let logger = Logger(subsystem: EnvironmentConfiguration.shared.bundleIdentifier, category: "BGTaskRegistrar")
