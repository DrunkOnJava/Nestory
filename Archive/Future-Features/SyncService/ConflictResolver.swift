...
public struct AutomaticConflictResolver: ConflictResolver, Sendable {
    private let logger = Logger(subsystem: EnvironmentConfiguration.shared.bundleIdentifier, category: "ConflictResolver")
...
public struct ManualConflictResolver: ConflictResolver, @unchecked Sendable {
    ...
    private let logger = Logger(subsystem: EnvironmentConfiguration.shared.bundleIdentifier, category: "ManualResolver")
...
public struct RuleBasedConflictResolver: ConflictResolver, @unchecked Sendable {
    ...
    private let logger = Logger(subsystem: EnvironmentConfiguration.shared.bundleIdentifier, category: "RuleBasedResolver")
...
extension RuleBasedConflictResolver.Rule {
    public static var preferNewest: Self {
    ...
    public static var preferHigherQuantity: Self {
    ...
    public static var preferHigherPrice: Self {
